...
public class TopBarView extends ConstraintLayout {
    ...
    private void initView(Context context){
        ...
        imgLogo = findViewById(R.id.ic_top_bar_logo);
        ...
        txtUserInfo = findViewById(R.id.txt_user_top_bar_logout);
        updateUserImg();
    }
    ...
    private void initListener(){
        ...
        imgSettings.setOnClickListener(v -> {
            if(onSettingsItemClickListener != null){
                ...
                try {
                    Intent intent = new Intent(v.getContext(), Class.forName("com.zwn.launcher.SettingsActivity"));
                    v.getContext().startActivity(intent);
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }
    ...
    public void updateUserImg(){
        if(CommonUtils.isUserLogin()){
            ...
            imgUser.setImageResource(R.mipmap.top_bar_user_logout);
